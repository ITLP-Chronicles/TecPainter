...
public:
    ...
    QPushButton *btnCaminar;
    QPushButton *btnUpView;
    QPushButton *btnSideView;
    QPushButton *btnBottomView;
    QMenuBar *menubar;
    QMenu *menuMen;
    QMenu *menuL_nea;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setGeometry(QRect(180, 530, 361, 20));
        ...
        btnVuelta->setGeometry(QRect(30, 500, 80, 18));
        btnMarometa = new QPushButton(centralwidget);
        btnMarometa->setObjectName("btnMarometa");
        btnMarometa->setGeometry(QRect(140, 500, 80, 18));
        btnGiro = new QPushButton(centralwidget);
        btnGiro->setObjectName("btnGiro");
        btnGiro->setGeometry(QRect(250, 500, 80, 18));
        btnGiroCabeza = new QPushButton(centralwidget);
        btnGiroCabeza->setObjectName("btnGiroCabeza");
        btnGiroCabeza->setGeometry(QRect(360, 500, 80, 18));
        btnCaminar = new QPushButton(centralwidget);
        btnCaminar->setObjectName("btnCaminar");
        btnCaminar->setGeometry(QRect(470, 500, 80, 18));
        btnUpView = new QPushButton(centralwidget);
        btnUpView->setObjectName("btnUpView");
        btnUpView->setGeometry(QRect(670, 70, 80, 18));
        btnSideView = new QPushButton(centralwidget);
        btnSideView->setObjectName("btnSideView");
        btnSideView->setGeometry(QRect(670, 220, 80, 18));
        btnBottomView = new QPushButton(centralwidget);
        btnBottomView->setObjectName("btnBottomView");
        btnBottomView->setGeometry(QRect(670, 380, 80, 18));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnCaminar->setText(QCoreApplication::translate("MainWindow", "Caminar", nullptr));
        btnUpView->setText(QCoreApplication::translate("MainWindow", "Vista superior", nullptr));
        btnSideView->setText(QCoreApplication::translate("MainWindow", "Vista lateral", nullptr));
        btnBottomView->setText(QCoreApplication::translate("MainWindow", "Vista inferior", nullptr));
